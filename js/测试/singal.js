 ...
 */
var receiveFromCourseware = (function () {
  var platformMap = [
    'android',
    'ios',
    'mac',
    ...
    switch (platformType) {
      ...
      case platformMap[1]: // ios
        if (window.webkit) {
          ...
          window.webkit.messageHandlers.xesApp.postMessage(
  ...
  return function receiveFromCourseware(data) {
    // console.log(
    //   'xesweblog:From signal.js ===> receiveFromCourseware parameter' + data
    // );
    var msgInfo = '';
    ...
    log('receiveFromCourseware: ' + msgInfo);
